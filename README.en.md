...
See [exampleSite/hugo.toml](exampleSite/hugo.toml) for a complete example. The example site is
Chinese-only; the theme ships with zh-CN / en / ja strings.
...
[IBM Plex](https://github.com/IBM/plex) (IBM open-source font license).
